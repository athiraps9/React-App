     ...
     gap-6 rounded-lg shadow-lg'>
      ...
      { currState === "Sign up" && !isDataSubmitted && (
        <input onChange={(e)=>setFullName(e.target.value)} value={fullName}
         type='text'className='p-2 border border-gray-500 rounded-b-md focus:outline-none focus:ring-2 focus:ring-indigo-500' placeholder="Full Name" required/>
      )}
      
      {!isDataSubmitted && (
        <>
        <input onChange={(e)=>setEmail(e.target.value)} value={email}
         type="email" placeholder='Email Address' required className='p-2 border border-gray-500 rounded-b-md focus:outline-none focus:ring-2 focus:ring-indigo-500' />

         <input onChange={(e)=>setPassword(e.target.value)} value={password}
         type="password" placeholder="Password" required className='p-2 border border-gray-500 rounded-b-md focus:outline-none focus:ring-2 focus:ring-indigo-500' />
...

      {
        currState === "Sign up" && isDataSubmitted && (
          ...
          rows={4} className='p-2 border border-gray-500 rounded-b-md focus:outline-none focus:ring-2 focus:ring-indigo-500' placeholder="provide short bio" required>
          </textarea>
        )
      }
